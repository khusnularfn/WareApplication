...
import com.example.aplikasigudang.adapter.AdapterGudang
import com.example.aplikasigudang.adapter.FileAdapter
import com.example.aplikasigudang.databinding.ActivityListKepalaGudangBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.storage.FirebaseStorage
import com.google.firebase.storage.StorageReference
import java.io.File

class ListKepalaGudang : AppCompatActivity(), AdapterGudang.FileItemClickListener {
    private lateinit var recyclerView: RecyclerView
    private val storageReference: StorageReference = FirebaseStorage.getInstance().reference
    private lateinit var auth: FirebaseAuth
    private lateinit var sharedPreferences: SharedPreferences
    private lateinit var binding: ActivityListKepalaGudangBinding
    override fun onCreate(savedInstanceState: Bundle?) {

        super.onCreate(savedInstanceState)
        binding = ActivityListKepalaGudangBinding.inflate(layoutInflater)
        ...
        val folderReference = storageReference.child("kepala_gudang_files")

        folderReference.listAll().addOnSuccessListener { listResult ->

            val fileList = listResult.items // Daftar file dari folder
            val adapter = AdapterGudang(fileList, this) // Set this as the FileItemClickListener
...
//
//        val sourcePath = "kepala_gudang_files/${fileToMove.name}" // Path as per your current structure
...
//    }
    ...
    private fun logoutUser() {
        // Clear the user-related data from SharedPreferences (or other storage)
