...
class AdapterGudang(val fileList: MutableList<StorageReference>, private val fileItemClickListener: FileItemClickListener) : RecyclerView.Adapter<AdapterGudang.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.buttonBiru.visibility = View.GONE
        holder.buttonMerah.visibility = View.GONE
